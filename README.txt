...
Name: WP CroBox
Donate link: http://neshable.com
Tags: popup, box, popup box
...
See screenshots for additional information.
...
* Initial release.
- Customizable colors
- Change button text, box text, add/edit footer and more.
- Show popup box at user-selected scroll position.
